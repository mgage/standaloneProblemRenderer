...
echo "$WEBWORK_ROOT/DATA/bad_problems.txt"
time find $1 -name "*.pg" -exec /Volumes/WW_test/opt/webwork/standaloneProblemRenderer/standalonePGproblemRenderer.pl  {} ';'  #tail -f /Volumes/WW_test/opt/webwork/webwork2/DATA/bad_problems.txt;
echo "start search"
